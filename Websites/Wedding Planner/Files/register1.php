...
<form method="post" action="register1.php" class="login">
    <p>
      <label for="login">Email:</label>
      <input type="text" name="email" id="login" value="Enter email address">
    </p>

    <p>
      <label for="login">Username:</label>
      <input type="text" name="uname" id="login" value="Enter username">
    </p>
    <p>
      <label for="password">Password:</label>
      <input type="password" name="password" id="password" value="Enter password">
    </p>
    ...
    <p class="forgot-password" onclick="popup()">Forgot your password?</a></p>
        <p class="forgot-password" ><a href="login1.php">Login</a></p>
  </form>
...
<?php
$con = mysqli_connect("localhost","root","","admin2");
...
$query = "INSERT INTO register2(email, password, username) VALUES('$_POST[email]','$newpwd', '$_POST[uname]')";
